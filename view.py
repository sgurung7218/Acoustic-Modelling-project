...
class View(ttk.Frame):
    def __init__(self,parent):
        ...
        self._quit_btn.grid(row=3, column=0, sticky=("S", "E"), padx=5)
    ...
    def load_audio(self):
        ...
        #print(self.filePath)
        #self.filePath = filedialog.askopenfile(title="Select an audio file")
        #print(self.filePath)
        if self.filePath == "":
            self.alert("Select a file")
        else:
...
loadedfile = 0 #this variable checks if the user has a file ready